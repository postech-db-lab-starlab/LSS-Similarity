...
##############################################################################################################################
def alignNouns(source, target, sourceDParse, targetDParse, existingAlignments):
...
##############################################################################################################################
def alignMainVerbs(source, target, sourceDParse, targetDParse, existingAlignments):
# source and target:: each is a list of elements of the form:
# [[character begin offset, character end offset], word index, word, lemma, pos tag]
...
##############################################################################################################################
def alignAdjectives(source, target, sourceDParse, targetDParse, existingAlignments):
# source and target:: each is a list of elements of the form:
# [[character begin offset, character end offset], word index, word, lemma, pos tag]
...
##############################################################################################################################
def alignAdverbs(source, target, sourceDParse, targetDParse, existingAlignments):
# source and target:: each is a list of elements of the form:
# [[character begin offset, character end offset], word index, word, lemma, pos tag]
...
##############################################################################################################################
def alignNamedEntities(source, target, sourceNamedEntities, targetNamedEntities, existingAlignments):
# source and target:: each is a list of elements of the form:
# [[character begin offset, character end offset], word index, word, lemma, pos tag]
...
##############################################################################################################################
def alignWords((source, sourceDParse, sourceNamedEntities), (target, targetDParse, targetNamedEntities)):
# source and target:: each is a list of elements of the form:
# [[character begin offset, character end offset], word index, word, lemma, pos tag]
...
# ]
    ...
    neAlignments = alignNamedEntities(source, target, sourceNamedEntities, targetNamedEntities, alignments)
    ...
    mainVerbAlignments = alignMainVerbs(source, target, sourceDParse, targetDParse, alignments)
    ...
    nounAlignments = alignNouns(source, target, sourceDParse, targetDParse, alignments)
    ...
    adjectiveAlignments = alignAdjectives(source, target, sourceDParse, targetDParse, alignments)
    ...
    adverbAlignments = alignAdverbs(source, target, sourceDParse, targetDParse, alignments)
...
def align(sentence_info1, sentence_info2):
    (LemmasAndPosTags1, DParse1, Named_entities1) = sentence_info1
    (LemmasAndPosTags2, DParse2, Named_entities2) = sentence_info2
    myWordAlignments = alignWords(sentence_info1, sentence_info2)
